workspace {
    ...
    model {
        ...
        eSett = softwareSystem "eSett" "eSett" 
        ...
        migration -> ws "Provides migrated data" "using Delta tables"
        edi -> ws "Provides delations" "using events and HTTP REST"
        mp -> ws "Provides organisation and actor data" "using events and HTTP REST"
        ...
        actor -> dh2 "Current integration" 

    }

    views {
        
        dynamic dh3 "DataFlow" "Summarises how data flows to wholesale." {
            migration -> ws "Metering point data, Charges, Timeseries, GridAreas, Market roles"
            mp -> ws "Actors, Organisations, BRP relations"
            edi -> ws "Delegations"
            autoLayout
        }
