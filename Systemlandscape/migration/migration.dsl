workspace extends ../architectualRunway.dsl {
    model {
        !ref migration {
            bronzeNotebook = component "Bronze Layer Notebook" "Extract migrated JSON files and load into bronze table" "Databricks Notebook"
            silverNotebook = component "Silver Layer Notebook" "Read bronze table data and transform to queryable dataframe" "Databricks Notebook"
            goldNotebook = component "Gold Layer Notebook" "Transform silver table data to conform to wholesale schemas" "Databricks Notebook"
